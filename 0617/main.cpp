...
int main() {
    vector<int> root1_ = {1,3,2,5}, root2_ = {2,1,3,null,4,null,7};

    TreeNode* root1 = createTree(root1_), *root2 = createTree(root2_);

    TreeNode* ans = Solution().mergeTrees(root1, root2);

    printTree(ans, nullptr, false);
}